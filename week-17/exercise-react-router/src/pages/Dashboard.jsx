...
export const Dashboard = () => {
  ...
  */
  ...
  const navigationHistory = [
    { path: "/", timestamp: "Complete the exercise to see real data" },
  ];
  ...
  return (
    <div className="page dashboard">
      ...
      {/* 
        BONUS: Access location.search for query params
        BONUS: Access location.state for data passed during navigation
        
        Example: When navigating with state:
        navigate("/dashboard", { state: { fromProduct: "Laptop" } })
        
        Then access it:
        const { state } = useLocation();
        console.log(state?.fromProduct); // "Laptop"
      */}
    </div>
  );
};
